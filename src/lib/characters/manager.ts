...
export const characterManager = {
    ...
    /**
     * 既存のAPI互換性のために、一般的なメソッドを代理実行
     * MemoryManagerが必要ない場合のフォールバック
     */
